    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.URLField(blank=True, default='https://i.pravatar.cc/150', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('In Transit', 'In Transit'), ('Out for Delivery', 'Out for Delivery'), ('Delivered', 'Delivered')], default='Pending', max_length=20)),
                ...
                ('start_location_lng', models.FloatField(blank=True, null=True)),
                ('end_location_lat', models.FloatField(blank=True, null=True)),
                ('end_location_lng', models.FloatField(blank=True, null=True)),
                ('route_polyline', models.TextField(blank=True, null=True)),
                ('agent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.deliveryagent')),
