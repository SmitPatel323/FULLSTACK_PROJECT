...
class User(AbstractUser):
    ...
    # avatar = models.URLField(blank=True, null=True, default="https://i.pravatar.cc/150")
    # Change this from URLField to CharField to store the image path
...
class Vehicle(models.Model):
    ...
    # --- NEW FIELD TO TRACK TOTAL MILEAGE ---
