...
//     const monthlyChartData = data.charts.monthlyVolume.labels.map((label, i) => ({ name: label, shipments: data.charts.monthlyVolume.data[i] }));
...
//                 <StatCard title="Low Stock Alerts" value={data.stats.lowStockAlerts} icon={<AlertTriangle size={32}/>} />
//             </div>
//             <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '1.5rem', marginTop: '1.5rem' }}>
//                 <div className="card">
//                     <h3 style={{fontWeight: 600}}>Monthly Volume</h3>
